		...
		technologies: [
			{
				name: 'React',
				icon: 'react',
				styles: 'text-react-ink bg-react/10 dark:text-react dark:bg-react/10',
			},
			{
				name: 'TypeScript',
				icon: 'typescript',
				styles: 'text-typescript-ink bg-typescript/10 dark:text-typescript-dark dark:bg-typescript/10',
			},
			{
				name: 'Tailwind CSS',
				icon: 'tailwind',
				styles: 'text-tailwindcss-ink bg-tailwindcss/10 dark:text-tailwindcss dark:bg-tailwindcss/10',
			},
			{
				name: 'Zustand',
				icon: 'zustand',
				styles: 'text-zustand-ink bg-zustand/10 dark:text-zustand dark:bg-zustand/10',
			},
		],
